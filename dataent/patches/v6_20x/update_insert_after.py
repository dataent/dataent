...
def execute():
	for ps in dataent.get_all('Property Setter', filters={'property': '_idx'},
		...
		if custom_fields:
			...
			for custom_field in custom_fields:
				...
				dataent.db.set_value('Custom Field', custom_field.name, 'insert_after', prev_fieldname)
				dataent.db.set_value('Custom Field', custom_field.name, 'idx', custom_field_idx)
