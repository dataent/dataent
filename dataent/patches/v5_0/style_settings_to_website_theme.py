...
def migrate_style_settings():
	style_settings = dataent.db.get_singles_dict("Style Settings")
	standard_website_theme = dataent.get_doc("Website Theme", "Standard")

	website_theme = dataent.copy_doc(standard_website_theme)
	...
	website_theme.no_sidebar = cint(dataent.db.get_single_value("Website Settings", "no_sidebar"))
