dataent.listview_settings['ToDo'] = {
	onload: function(me) {
	...
	refresh: function(me) {
		...
		me.page.sidebar.find(".assigned-to-me a").off("click").on("click", function() {
			...
			me.filter_list.add_filter(me.doctype, "owner", '=', dataent.session.user);
			me.run();
		});
		...
		me.page.add_sidebar_item(__("Assigned By Me"), function() {
			...
			me.filter_list.add_filter(me.doctype, "assigned_by", '=', dataent.session.user);
			me.run();
		}, ".assigned-to-me");
	},
