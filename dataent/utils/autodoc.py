...
import inspect, importlib, re, dataent
...
def get_version(name):
	...
	def _for_module(m):
		...
		try:
			docs_version = dataent.get_attr(app_name + ".config.docs.docs_version")
...
def get_function_info(value):
	...
	return {
		...
		"whitelisted": value in dataent.whitelisted
	}
