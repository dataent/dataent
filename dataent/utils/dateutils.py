...
def get_user_date_format():
	if getattr(dataent.local, "user_date_format", None) is None:
		dataent.local.user_date_format = dataent.defaults.get_global_default("date_format") or "yyyy-mm-dd"

	return dataent.local.user_date_format
