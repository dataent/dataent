...
from dataent.permissions import add_user_permission, clear_user_permissions_for_doctype
...
class TestReportview(unittest.TestCase):
	...
	def test_build_match_conditions(self):
		...
		test2user = dataent.get_doc('User', 'test2@example.com')
	...
	def test_ignore_permissions_for_get_filters_cond(self):
		dataent.set_user('test2@example.com')
		self.assertRaises(dataent.PermissionError, get_filters_cond, 'DocType', dict(istable=1), [])
		self.assertTrue(get_filters_cond('DocType', dict(istable=1), [], ignore_permissions=True))
		dataent.set_user('Administrator')

	def test_query_fields_sanitizer(self):
		self.assertRaises(dataent.DataError, DatabaseQuery("DocType").execute,
	...
	def test_of_not_of_descendant_ancestors(self):
		...
		data = dataent.get_all('File', {'name': ('descendants of', 'Home/level1-A/level2-A')})
		self.assertTrue({"name": "Home/level1-A/level2-A/level3-A"} in data)

		data = dataent.get_all('File', {'name': ('descendants of', 'Home/level1-A')})
		self.assertTrue({"name": "Home/level1-A/level2-A/level3-A"} in data)
		self.assertTrue({"name": "Home/level1-A/level2-A"} in data)
		self.assertTrue({"name": "Home/level1-A/level2-B"} in data)
		self.assertFalse({"name": "Home/level1-B"} in data)
		...
		data = dataent.get_all('File', {'name': ('ancestors of', 'Home/level1-A/level2-A')})
		...
		data = dataent.get_all('File', {'name': ('ancestors of', 'Home/level1-A')})
		self.assertFalse({"name": "Home/level1-A/level2-A/level3-A"} in data)
		self.assertFalse({"name": "Home/level1-A/level2-A"} in data)
		self.assertFalse({"name": "Home/level1-A/level2-B"} in data)
		self.assertFalse({"name": "Home/level1-B"} in data)
		...
		data = dataent.get_all('File', {'name': ('not descendants of', 'Home/level1-A/level2-A')})
		self.assertFalse({"name": "Home/level1-A/level2-A/level3-A"} in data)
		self.assertTrue({"name": "Home/level1-A/level2-A"} in data)
		self.assertTrue({"name": "Home/level1-A/level2-B"} in data)
		self.assertTrue({"name": "Home/level1-A"} in data)
		...
		data = dataent.get_all('File', {'name': ('not descendants of', 'Home/level1-A')})
		self.assertFalse({"name": "Home/level1-A/level2-A/level3-A"} in data)
		self.assertFalse({"name": "Home/level1-A/level2-A"} in data)
		self.assertFalse({"name": "Home/level1-A/level2-B"} in data)
		...
		data = dataent.get_all('File', {'name': ('not ancestors of', 'Home/level1-A/level2-A')})
		self.assertTrue({"name": "Home/level1-A/level2-A/level3-A"} in data)
		self.assertTrue({"name": "Home/level1-A/level2-A"} in data)
		self.assertTrue({"name": "Home/level1-A/level2-B"} in data)
		self.assertTrue({"name": "Home/level1-B"} in data)
		...
		data = dataent.get_all('File', {'name': ('not ancestors of', 'Home/level1-A')})
		self.assertTrue({"name": "Home/level1-A/level2-A/level3-A"} in data)
		self.assertTrue({"name": "Home/level1-A/level2-A"} in data)
		self.assertTrue({"name": "Home/level1-A/level2-B"} in data)
		self.assertTrue({"name": "Home/level1-B"} in data)
		...
		self.assertTrue(len(dataent.get_all('File', {'name': ('not ancestors of', 'Home')})) == len(dataent.get_all('File')))
...
def delete_test_file_hierarchy():
	...
	for file_name in files_to_delete:
		dataent.delete_doc('File', file_name)
