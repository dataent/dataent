...
from dataent.utils import evaluate_filters, money_in_words, scrub_urls, get_url
from dataent.utils import ceil, floor
...
class TestDataManipulation(unittest.TestCase):
	def test_scrub_urls(self):
		...
		self.assertTrue('<img src="{0}/assets/dataent/test.jpg">'.format(url) in html)
		self.assertTrue('style="background-image: url(\'{0}/assets/dataent/bg.jpg\') !important"'.format(url) in html)
