...
from dataent.email.receive import Email
from dataent.email.email_body import (replace_filename_with_cid,
...
<div>
	...
	<img embed="assets/dataent/images/favicon.png" />
</div>
'''
		email_text = '''
Hey John Doe!
...
'''
		...
		img_path = os.path.abspath('assets/dataent/images/favicon.png')
...
'''
	...
	def test_replace_filename_with_cid(self):
		original_message = '''
			<div>
				<img embed="assets/dataent/images/favicon.png" alt="test" />
...
From: test1_@epaas.xyz
Reply-To: test2_@epaas.xyz
""" + text_content_bytes
