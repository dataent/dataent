...
# test_records = dataent.get_test_records('Auto Email Report')

class TestAutoEmailReport(unittest.TestCase):
	def test_auto_email(self):
		dataent.delete_doc('Auto Email Report', 'Permitted Documents For User')

		auto_email_report = dataent.get_doc(dict(
