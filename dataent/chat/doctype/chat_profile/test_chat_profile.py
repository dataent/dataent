...
from dataent.chat.doctype.chat_profile import chat_profile
from dataent.chat.util import get_user_doc, create_test_user
...
class TestChatProfile(unittest.TestCase):
	...
	# 	with self.assertRaises(dataent.ValidationError):
