export default class WebForm {
	...
	get_data() {
		dataent.call({
			method: 'dataent.website.doctype.web_form.web_form.get_form_data',
			args: {
	...
	render(doc, web_form) {
		const query_params = dataent.utils.get_query_params();
		...
		this.field_group = new dataent.ui.FieldGroup({
			parent: this.wrapper,
