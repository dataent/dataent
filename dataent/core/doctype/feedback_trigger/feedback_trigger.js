...
dataent.ui.form.on('Feedback Trigger', {
	onload: function(frm) {
	...
	setup_field_options: function(frm) {
		...
		dataent.model.with_doctype(frm.doc.document_type, function() {
			var fields = dataent.get_doc("DocType", frm.doc.document_type).fields;
			$.each(fields, function(idx, field) {
				if(!in_list(dataent.model.no_value_type, field.fieldtype) && field.options == "Email") {
