// for testing
dataent.click_button = function(text, idx) {
	let container = '';
...
dataent.click_link = function(text, idx) {
...
dataent.click_element = function(selector, idx) {
...
dataent.set_control= function(fieldname, value) {
...
dataent.click_check = function(label, idx) {
