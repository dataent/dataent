dataent.ui.form.ControlAttach = dataent.ui.form.ControlData.extend({
	make_input: function() {
		var me = this;
	...
	onclick: function() {
		var me = this;
		if(this.doc) {
			var doc = this.doc.parent && dataent.model.get_doc(this.doc.parenttype, this.doc.parent) || this.doc;
			if (doc.__islocal) {
				dataent.msgprint(__("Please save the document before uploading."));
				return;
			}
		}
		if(!this.dialog) {
		...
		dataent.upload.make(this.upload_options);
	},
