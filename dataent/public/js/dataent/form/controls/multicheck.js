dataent.ui.form.ControlMultiCheck = dataent.ui.form.Control.extend({
	...
	parse_df_options() {
		...
		} else if(this.df.options && this.df.options.length>0 && dataent.utils.is_json(this.df.options)) {
