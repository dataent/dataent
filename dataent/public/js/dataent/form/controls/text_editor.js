...
dataent.ui.form.ControlTextEditor = dataent.ui.form.ControlCode.extend({
	make_wrapper() {
		this._super();
	...
	bind_events() {
		this.quill.on('text-change', dataent.utils.debounce((delta, oldDelta, source) => {
	...
	parse(value) {
		...
		return dataent.dom.remove_script_and_style(value);
	},
