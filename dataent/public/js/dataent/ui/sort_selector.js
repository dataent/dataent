dataent.ui.SortSelector = Class.extend({
	// parent:
	// change:
	// args:
	...
	make: function() {
		...
		this.wrapper = $(dataent.render_template('sort_selector', this.args)).appendTo(this.parent);
		this.bind_events();
	},
	...
	get_label: function(fieldname) {
		if(fieldname==='idx') {
			...
			return this.labels[fieldname]
				|| dataent.meta.get_label(this.doctype, fieldname);
		}
	},
