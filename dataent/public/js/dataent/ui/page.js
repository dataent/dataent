 ...
 *
 * @returns {dataent.ui.Page}
 */

/**
 * @typedef {Object} dataent.ui.Page
 */


dataent.ui.make_app_page = function(opts) {
	opts.parent.page = new dataent.ui.Page(opts);
	return opts.parent.page;
}

dataent.ui.pages = {};

dataent.ui.Page = Class.extend({
	init: function(opts) {
		$.extend(this, opts);
		...
		this.make();
		dataent.ui.pages[dataent.get_route_str()] = this;
	},
	...
	add_main_section: function() {
		$(dataent.render_template("page", {})).appendTo(this.wrapper);
	...
	*/
	...
	set_title: function(txt, icon = '', stripHtml = true, tabTitle = '') {
		...
		dataent.utils.set_title(tabTitle || txt);
		if(icon) {
	...
	add_dropdown_button: function(parent, label, click, icon) {
		dataent.ui.toolbar.add_dropdown_button(parent, label, click, icon);
	},
