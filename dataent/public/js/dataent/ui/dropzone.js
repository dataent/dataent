// DropZone
dataent.ui.DropZone = class 
{
	constructor (selector, options) {
		this.options    = Object.assign({ }, dataent.ui.DropZone.OPTIONS, options);
		this.$container = $(selector);
		this.$wrapper   = $(dataent.ui.DropZone.TEMPLATE);
