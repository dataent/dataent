...
from dataent.utils import get_site_name, get_site_path, get_site_base_path, get_path, cstr
...
class StaticDataMiddleware(SharedDataMiddleware):
	...
	def get_directory_loader(self, directory):
		def loader(path):
			site = get_site_name(dataent.app._site or self.environ.get('HTTP_HOST'))
